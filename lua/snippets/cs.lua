...
return {
    ...
    s("class", {
        f(function() return get_namespace() end), t({"", "", "public class "}),
        f(function() return get_filename() end), t({"", "{", ""}), i(1),
        t({"", "}"})
    }), s("interface", {
    ...
    s("prop", {t("public "), i(1, "Type"), i(2, "Name"), t(" { get; set; }")}),
    s("func", {
        t("public "), i(1, "Return"), i(2, "Name"), t(" ("), i(3, "args"),
        t({") {", ""}), i(4, "args"), t({"", "}"})
    }), s("foreach", fmt([[
foreach (var item in {})
{{
...
]], {i(1, "myList"), i(2, "// loop body")})), s("wld", {
        t('Console.WriteLine($"'), f(getSymbol, {1}), t(': {'),
        i(1, "Variable"), t('}");')
    })
