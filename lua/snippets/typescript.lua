...
return {
    ...
    -- class snippet
    s("class", {
        t("class "), f(function() return get_filename() end), t({ " {", "\tconstructor() {", "\t\t" }),
        i(1), t({ "", "\t}", "", "\t" }), i(0), t({ "", "}" })
    }),

    -- interface snippet
    s("interface", {
        t("interface "), f(function() return get_filename() end), t({ " {", "\t" }), i(1), t({ "", "}" })
    }),
    ...
    -- function snippet
    s("func", {
        t("function "), i(1, "functionName"), t("("), i(2, "args"), t({ "): " }), i(3, "ReturnType"), t({ " {", "\t" }),
        i(4, "// function body"), t({ "", "}" })
    }),
